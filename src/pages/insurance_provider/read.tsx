          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                    <span className="text-sm text-secondary-foreground">Location</span>
                    <p className="font-mono text-sm bg-secondary px-2 py-1 rounded">
                    {data?.location ? `${data.location.state} - ${data.location.city}` : "N/A"}</p>
                </div>
              </CardContent>
            </Card>
          </div>
...
export default ReadInsuranceProvider;
